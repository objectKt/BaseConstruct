...
class RoundProgressBar(context: Context, attrs: AttributeSet? = null) : View(context, attrs) {
    ...
    private var circleColor = ContextCompat.getColor(
        context,
        R.color.DimGray
    )
    ...
    private var progressColor = ContextCompat.getColor(
        context,
        R.color.Teal
    )
    private var progressTextColor = ContextCompat.getColor(
        context,
        R.color.Teal
    )
    ...
    private var progressBgColor = ContextCompat.getColor(
        context,
        R.color.Moccasin
    )
