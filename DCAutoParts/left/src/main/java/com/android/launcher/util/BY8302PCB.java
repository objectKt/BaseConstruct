...
//        new Thread(() -> {
//            String sendCode = "7E030102EF";
//            SerialHelperttlLd.sendHex(sendCode);
//        }).start();
    ...
    /**
     * @description: 音量设置 音量为 0-30 级可调，该指令可以实时修改调节音量，音量可以掉电记忆
     * @createDate: 2023/8/26
     */
