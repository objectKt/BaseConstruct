...
public final class CleanUtils {
    ...
    public static boolean cleanInternalSp() {
        return deleteFilesInDir(new File(app.getFilesDir().getParent(), "shared_prefs"));
    }
    ...
    public static boolean cleanExternalCache() {
        return Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState()) && deleteFilesInDir(app.getExternalCacheDir());
    }
