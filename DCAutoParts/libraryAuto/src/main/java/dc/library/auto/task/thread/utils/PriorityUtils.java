package dc.library.auto.task.thread.utils;

import dc.library.auto.task.thread.priority.IPriority;
import dc.library.auto.task.thread.priority.IPriorityStrategy;
import dc.library.auto.task.thread.priority.impl.DefaultPriorityStrategy;
