...
public class MenuPointView extends FrameLayout {
    ...
    private void setupInit(Context context) {
        LayoutInflater.from(context).inflate(R.layout.layout_menu_point_view, this, true);
    ...
    public void setPointNumber(int number) {
        Log.v(MenuPointView.class.getSimpleName(), "setPointNumber---number=" + number);
    ...
    private class PointAdapter extends RecyclerView.Adapter<PointViewHolder> {
        ...
        public PointViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_menu_point_view, parent, false);
        ...
        public void onBindViewHolder(@NonNull PointViewHolder holder, int position) {
            ...
            if (pointItem != null) {
                if (pointItem.isSelected()) {
                    holder.getPointView().setBackgroundResource(R.drawable.bg_item_menu_point_view_selected);
                } else {
                    holder.getPointView().setBackgroundResource(R.drawable.bg_item_menu_point_view_unselected);
                }
            }
        }
